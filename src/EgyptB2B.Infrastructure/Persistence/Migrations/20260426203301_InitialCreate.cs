        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApprovalAuditLogs_AspNetUsers_AdminUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierProfiles_AspNetUsers_ApprovedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Currency = table.Column<string>(type: "nchar(3)", fixedLength: true, maxLength: 3, nullable: false, defaultValue: "EGP"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Products_SupplierProfiles_SupplierProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inquiries_AspNetUsers_BuyerUserId",
                    ...
                    table.ForeignKey(
                        name: "FK_Inquiries_SupplierProfiles_SupplierProfileId",
                        column: x => x.SupplierProfileId,
                        principalTable: "SupplierProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("22222222-2222-2222-2222-222222222222"), "22222222-2222-2222-2222-222222222222", "Supplier", "SUPPLIER" },
                    { new Guid("33333333-3333-3333-3333-333333333333"), "33333333-3333-3333-3333-333333333333", "Buyer", "BUYER" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalAuditLogs_AdminUserId",
                table: "ApprovalAuditLogs",
                column: "AdminUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalAuditLogs_EntityType_EntityId",
                table: "ApprovalAuditLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inquiries_BuyerUserId_CreatedAtUtc",
                table: "Inquiries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inquiries_SupplierProfileId_Status",
                table: "Inquiries",
                columns: new[] { "SupplierProfileId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_InquiryMessages_InquiryId_CreatedAtUtc",
                table: "InquiryMessages",
                columns: new[] { "InquiryId", "CreatedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_SupplierProfileId_Slug",
                table: "Products",
                columns: new[] { "SupplierProfileId", "Slug" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Products_SupplierProfileId_Status",
                table: "Products",
                columns: new[] { "SupplierProfileId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierProfiles_ApprovalStatus",
                table: "SupplierProfiles",
                column: "ApprovalStatus");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierProfiles_ApprovedByUserId",
                table: "SupplierProfiles",
                column: "ApprovedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierProfiles_CommercialRegistrationNumber",
                table: "SupplierProfiles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierProfiles_CompanyName",
                table: "SupplierProfiles",
                column: "CompanyName");
